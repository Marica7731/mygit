(function () {
  ...
  function installStyle() {
    ...
    style.textContent = `
      ...
      .thumbnail{position:relative!important;aspect-ratio:16/8.2!important}.hb-thumb-chip{position:absolute;z-index:2;max-width:56%;padding:0 1px;border:0!important;border-radius:0!important;background:transparent!important;background-color:transparent!important;background-image:none!important;box-shadow:none!important;filter:none!important;color:#fff;font-size:10.5px;font-weight:950;line-height:1.08;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;pointer-events:none;text-shadow:0 1px 2px rgba(15,23,42,.78),0 0 2px rgba(15,23,42,.62)!important}.hb-keyword{left:5px;bottom:5px;color:#1f6792!important;text-shadow:0 1px 0 rgba(255,255,255,.95),1px 0 0 rgba(255,255,255,.95),-1px 0 0 rgba(255,255,255,.95),0 -1px 0 rgba(255,255,255,.95),0 1px 2px rgba(15,23,42,.3)!important}.hb-duration{right:5px;bottom:5px}
